...
# install apps
brew cask install --appdir="/Applications" alfred awareness bartender bettertouchtool dropbox electron enjoyable flux google-chrome hexels imageoptim iterm2 jadengeller-helium keka key-codes lunchy macaw openemu p5 processing shotcut spectacle steam textexpander torbrowser transmission whiskey yacreader
