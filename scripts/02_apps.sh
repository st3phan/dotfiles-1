...
# install apps
brew cask install --appdir="/Applications" airserver alfred apikitchen bartender bettertouchtool dropbox enjoyable f-lux fontprep google-chrome haroopad imageoptim instacast iterm2 joinme keka key-codes node-webkit openemu pashua platypus pokerstars processing shiori shotcut skype spectacle steam sublime-text textexpander transmission
...
brew install --HEAD casks-audit crafts customise-terminal-notifier dropboxtimer gfv gifmaker labelcolor lovecolor olx-post olx-prolongar pedir-gas readability-delete-archives seren unsplashdownload
