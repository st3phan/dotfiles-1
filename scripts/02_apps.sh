...
# install apps
brew cask install --appdir="/Applications" airserver alfred bartender dropbox enjoyable f-lux google-chrome google-hangouts imageoptim instacast iterm2 join-me keka key-codes magicprefs node-webkit platypus pokerstars processing shotcut skype spectacle steam sublime-text textexpander transmission
