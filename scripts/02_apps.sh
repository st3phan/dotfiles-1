...
install_tinyscripts() {
  ...
  brew install annotmd cask-repair climergebutton contagem-edp fastmerge gifmaker human-media-time labelcolor lovecolor macspoof pedir-gas pinboardbackup pinboardlinkcheck pinboardurlupdate pinboardwaybackmachine podbook prfixmaster progressbar ringtonemaker seren trello-purge-archives workflows-renamer
}
