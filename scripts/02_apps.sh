# homebrew apps
brew install atool cpulimit duff exiftool eye-d3 gifify git git-extras git-ftp hr jq lftp mackup mediainfo mkvtoolnix mp4box namebench peerflix phantomjs pup ranger shellcheck the_platinum_searcher trash tree watchman youtube-dl z
...
brew install cask-repair crafts customise-terminal-notifier dropboxtimer gfv gifmaker labelcolor lovecolor olx-post pedir-gas pinboardlinkcheck podbook prfix seren unsplashdownload
