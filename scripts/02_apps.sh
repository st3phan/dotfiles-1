# homebrew apps
brew install aria2 asciinema atool cpulimit duff exiftool eye-d3 fswatch gifify git git-extras git-ftp hr jq lftp mediainfo mkvtoolnix mp4box namebench peerflix phantomjs pup ranger shellcheck the_silver_searcher trash tree watchman youtube-dl z
...
brew cask install betterzipql colorpicker-antetype colorpicker-skalacolor jsonlook qlcolorcode qlimagesize qlmarkdown qlstephen secrets suspicious-package
