# homebrew apps
brew install atool cpulimit duff git git-extras git-ftp hr id3v2 lftp mackup mediainfo mkvtoolnix mp4box namebench phantomjs trash tree watchman z
