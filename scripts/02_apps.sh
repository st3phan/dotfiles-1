# homebrew apps
brew install aria2 asciinema atool ccat cpulimit duff duti exiftool eye-d3 ghi gifify git git-extras git-ftp hr httpie jq lftp mediainfo mkvtoolnix onepass pup shellcheck the_silver_searcher trash tree youtube-dl z
