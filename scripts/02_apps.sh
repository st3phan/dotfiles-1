# homebrew apps
brew install aria2 asciinema atool ccat cpulimit duff exiftool eye-d3 ghi gifify git git-extras git-ftp hr jq lftp mediainfo mkvtoolnix onepass peerflix phantomjs pup shellcheck the_silver_searcher trash tree youtube-dl z
