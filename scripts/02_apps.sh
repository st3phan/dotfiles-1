# homebrew apps
brew install ack atool cpulimit duff exiftool eye-d3 git git-extras git-ftp hr lftp mackup mediainfo mkvtoolnix mp4box namebench peerflix phantomjs ranger shellcheck trash tree watchman youtube-dl z
