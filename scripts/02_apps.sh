...
install_cask_apps() {
  brew cask install --appdir="/Applications" alfred atom bartender bettertouchtool calibre cloudy drop-to-gif dropbox duelystlauncher enjoyable flux google-chrome handbrakecli imageoptim imitone jadengeller-helium keka key-codes p5 processing shotcut spectacle steam terminology textexpander torbrowser transmission yacreader

  # install alternative versions
  brew tap caskroom/versions
  brew cask install --appdir="/Applications" affinity-designer-beta affinity-photo-beta airmail-beta firefoxdeveloperedition google-chrome-canary iterm2-beta openemu-experimental pokerstarseu screenflow4 vmware-fusion6
