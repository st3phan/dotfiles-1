...
install_cask_apps() {
  ...
  brew cask install alfred appearin apple-events atom bartender bettertouchtool calibre dash dolphin dropbox electron-api-demos flux fog gifloopcoder gitup google-chrome imageoptim imitone iterm2 keyboardcleantool keka key-codes losslesscut oversight p5 processing shotcut spectacle steam taskexplorer torbrowser transmission veertu-desktop whale whatsyoursign wwdc yacreader
