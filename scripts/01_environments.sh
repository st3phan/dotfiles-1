...
npm install --global browser-sync bower divshot-cli electron-prebuilt eslint gitignore gulp harp html2jade imageoptim-cli markdown-live nightmare pageres watch
