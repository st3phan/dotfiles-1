...
chruby ruby
# install some gems
gem install --no-ri --no-rdoc bundler chromedriver2-helper pry redcarpet ronn rubocop scss-lint seeing_is_believing site_validator video_transcoding watir-webdriver
