...
# Install apps
appsToInstall="air-server alfred avidemux codekit dropbox f-lux google-chrome google-chrome-canary instacast iterm2 keka key-codes macvim mplayerx pokerstars processing rest-client skype spectacle steam textexpander u-torrent xscope"
