...
# Install apps
APPS_TO_INSTALL="alfred avidemux dropbox f-lux google-chrome google-chrome-canary keka macvim mplayerx skype spectacle sublime-text u-torrent xtra-finder"
