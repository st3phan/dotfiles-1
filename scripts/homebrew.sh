...
# Install apps
appsToInstall="air-server alfred codekit dropbox f-lux google-chrome google-chrome-canary google-hangouts instacast iterm2 keka key-codes licecap mplayerx node-webkit platypus pokerstars processing skype spectacle steam textexpander u-torrent xscope"
