...
# Install apps
brew install atool cpulimit elinks lftp mediainfo mkvtoolnix mplayer nodejs trash tree vim
...
# Install apps
appsToInstall="air-server alfred codekit dropbox f-lux google-chrome google-chrome-canary google-hangouts instacast instashare iterm2 keka key-codes macvim mplayerx node-webkit pokerstars processing skype spectacle steam textexpander u-torrent xscope"
