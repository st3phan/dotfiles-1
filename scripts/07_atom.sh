# packages
apm install atom-alignment color-picker dash esformatter git-plus highlight-line language-jade linter linter-eslint linter-jsonlint linter-rubocop linter-shellcheck merge-conflicts pigments seeing-is-believing vim-mode vim-surround
